...
## Out of scope
- Deep Linux system administration on the NAS (package management, DSM internals, reconfiguring services) — general confidence and safe navigation only, unless you ask to go further later.
